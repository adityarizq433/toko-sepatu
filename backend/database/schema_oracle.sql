-- ============================================
-- Skema Database untuk Oracle Database
-- Jalankan script ini di Oracle SQL Developer
-- ============================================

-- Menghapus tabel jika sudah ada (opsional, jalankan manual jika perlu reset)
/*
DROP TABLE reviews CASCADE CONSTRAINTS;
DROP TABLE order_items CASCADE CONSTRAINTS;
DROP TABLE orders CASCADE CONSTRAINTS;
DROP TABLE cart_items CASCADE CONSTRAINTS;
DROP TABLE product_sizes CASCADE CONSTRAINTS;
...
-- Tambahkan satu akun admin default
INSERT INTO users (nama, email, password, role) 
VALUES ('Admin', 'admin@tokosepatu.com', '$2b$10$wE9... (hash bcrypt)', 'admin');
COMMIT;
